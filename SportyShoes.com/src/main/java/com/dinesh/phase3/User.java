...
public class User {
	...
	public User(int user_id, String user_fname, String user_lname, String user_mail, 
			String user_phone, String user_pass, String user_dob, String user_conpass, 
			String user_state, String user_taluka, String user_dist, String user_gender, 
			String user_pin) {
		super();
		this.user_id = user_id;
		this.user_fname = user_fname;
