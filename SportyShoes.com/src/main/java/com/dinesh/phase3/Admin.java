...
public class Admin {
	...
	public Admin(int ad_id, String ad_dob, String ad_fname, String ad_lname, 
			String ad_phone, String ad_mail, String ad_pass, String ad_state, 
			String ad_con, String ad_dist, String ad_pin, String ad_taluka, 
			String log_date, String ad_gen) {
		super();
		this.ad_id = ad_id;
